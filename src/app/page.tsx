...
export default function Home() {
  ...
  return (
    <div className="flex flex-col flex-1 bg-background">
      <div id="gradient" className="flex flex-col items-center flex-1 pb-20">
        {/* Logo */}
        <div
          id="logo"
          className="relative mb-8 mx-auto bg-no-repeat bg-center bg-bottom animate-[fadeInDown_1s_ease-out] w-full max-w-[371px]"
          style={{ height: '207px' }}
        >
          <h1
      ...
      {showReportModal && (
        <ReportLink onClose={() => setShowReportModal(false)} onSuccess={handleReportSuccess} />
      )}
    </div>
  );
}
